 ...
 */
class SearchWordsProviderTest : AndroidBaseTest() {
    /** 맨 초기의 값을 가져오는 테스트 */
    @Test
    fun getInitValueTest() {
        val recents = SearchWordsProvider.init()
        println("getInitValueTest init : $recents")
        Assert.assertEquals(recents.size, 0)

        // 모든 데이터를 clear 해준다.
        SearchWordsProvider.deleteAll()
    }
    ...
    fun putTest() {
        ...
        var searchWords = SearchWordsProvider.init()
        ...
        SearchWordsProvider.put(RecentSearch(id = 0L, title = "test1"))
        SearchWordsProvider.put(RecentSearch(id = 1L, title = "test2"))
        SearchWordsProvider.put(RecentSearch(id = 2L, title = "test3"))
        SearchWordsProvider.put(RecentSearch(id = 3L, title = "test4"))
        SearchWordsProvider.put(RecentSearch(id = 4L, title = "test5"))
        SearchWordsProvider.put(RecentSearch(id = 5L, title = "test6"))
        SearchWordsProvider.put(RecentSearch(id = 6L, title = "test7"))
        SearchWordsProvider.put(RecentSearch(id = 7L, title = "test8"))
        SearchWordsProvider.put(RecentSearch(id = 8L, title = "test9"))
        SearchWordsProvider.put(RecentSearch(id = 9L, title = "test10"))
        SearchWordsProvider.put(RecentSearch(id = 10L, title = "test11"))
        searchWords = SearchWordsProvider.put(RecentSearch(id = 11L, title = "test12"))
        ...
        searchWords = SearchWordsProvider.put(RecentSearch(id = 5L, title = "test6"))
        ...
        searchWords = SearchWordsProvider.put(RecentSearch(id = 12L, title = "test13"))
    ...
    fun deleteTest() {
        ...
        // WHEN2 : 2L 데이터를 삭제한다.
        searchWords = SearchWordsProvider.delete("test3")
